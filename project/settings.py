...
ESEWA_PAYMENT_CALLBACK_URL= os.getenv("ESEWA_PAYMENT_CALLBACK_URL")

REST_FRAMEWORK = {
    "DEFAULT_PARSER_CLASSES": [
        "rest_framework.parsers.JSONParser",        # <-- For JSON payload
        "rest_framework.parsers.FormParser",        # <-- For form-data
        "rest_framework.parsers.MultiPartParser",   # <-- For files (if needed)
    ]
}
